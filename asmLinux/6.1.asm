...
asm_main:
        ...
        test eax, 11111111111111110000000000000000b                     ;is anything but the first 16 bit set? Dirty tricks because I am too lazy to find the right jump instruction for unsigned compares
        jnz abort
